...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const slideshows = {
        1: {
            images: [
                'https://matt.moses.name/sites/P10/facts1/P10_facts1_A.jpg',
            ...
            texts: [
                 "To stop rhino horn poaching, a complex solution is necessary that combines enhanced surveillance and law enforcement in conservation areas with community engagement and education to reduce economic incentives for poaching. International collaboration and stringent legislation are crucial to curb the demand and trade of rhino horns. Investing in scientific research and advanced technologies for tracking and monitoring rhino populations, along with establishing wildlife sanctuaries and relocation programs, can provide safer habitats. Additionally, global public awareness campaigns are vital to debunk myths about rhino horns and promote wildlife conservation ethics, contributing significantly to the protection of rhinos.",
...
const imagesArray1 = ["https://matt.moses.name/sites/P10/slides/P10_Set1A.png", "https://matt.moses.name/sites/P10/slides/P10_Set1B.png", "https://matt.moses.name/sites/P10/slides/P10_Set1C.png"];
const imagesArray2 = ["https://matt.moses.name/sites/P10/slides/P10_Set2A.png", "https://matt.moses.name/sites/P10/slides/P10_Set2B.png", "https://matt.moses.name/sites/P10/slides/P10_Set2C.png", "https://matt.moses.name/sites/P10/slides/P10_Set2D.png"];
const imagesArray3 = ["https://matt.moses.name/sites/P10/slides/P10_Set3A.png", "https://matt.moses.name/sites/P10/slides/P10_Set3B.png", "https://matt.moses.name/sites/P10/slides/P10_Set3C.png"];
const imagesArray4 = ["https://matt.moses.name/sites/P10/slides/P10_Set4A.png", "https://matt.moses.name/sites/P10/slides/P10_Set4B.png", "https://matt.moses.name/sites/P10/slides/P10_Set4C.png"];
